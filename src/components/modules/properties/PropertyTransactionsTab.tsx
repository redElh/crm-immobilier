...
export const PropertyTransactionsTab = ({ propertyId, propertyTitle, propertyRef }: {
  propertyId: string
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <p className="text-xs text-text-secondary">
          {transactions.length} transaction{transactions.length !== 1 ? 's' : ''} liée{transactions.length !== 1 ? 's' : ''} à <span className="font-medium text-text">{propertyTitle}</span>
        </p>
      </div>
