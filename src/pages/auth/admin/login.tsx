...
import { Mail, Lock, Check, Loader, Key } from 'react-feather'
...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast('success', 'Connexion réussie ! Bienvenue sur votre espace administration.')
  ...
  return (
    <AuthFormContainer title="Connexion Admin" subtitle="Connectez-vous à votre espace administration" backgroundImage="/CRM_Official_Image.jfif">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link to="/auth/admin/forgot-password" className="text-xs font-medium text-accent hover:text-accent-hover transition-colors">
            Mot de passe oublié ?
          </Link>
        </div>
        ...
        <p className="text-center text-xs text-text-secondary">
          ...
          <Link to="/auth/admin/register" className="font-medium text-accent hover:text-accent-hover">
            Inscrivez-vous
          </Link>
        </p>
      </form>
